...
public class SimpleFileDialog
{
                ...
                if (m_SimpleFileDialogListener != null){
                    {
                        ...
                        {
                            Selected_File_Name= message.getText() +"";
                                                             ...
                                                             DialogInterface.OnClickListener onClickListener)
    {
        ...
        if (Select_type == FileOpen || Select_type == FileSave)
        {
            message = new EditText(m_context);
            message.setText(Default_File_Name);
            titleLayout.addView(message);
        }
        //////////////////////////////////////////
    ...
    private void updateDirectory()
    {
        ...
        {
            message.setText(Selected_File_Name);
        }
    }
